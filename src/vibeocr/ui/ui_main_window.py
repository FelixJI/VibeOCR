...
class Ui_MainWindowWidget:
    def setupUi(self, MainWindowWidget):
        ...
        self.pipelineLayout.setObjectName("pipelineLayout")
        ...
        self.btnPipelineOCR.setObjectName("btnPipelineOCR")
        ...
        self.btnPipelineTable.setObjectName("btnPipelineTable")
        ...
        self.btnPipelineFormula.setObjectName("btnPipelineFormula")
        ...
        self.btnPipelineStructure.setObjectName("btnPipelineStructure")
        ...
        self.btnPipelinePaddleOCRVL.setObjectName("btnPipelinePaddleOCRVL")
        ...
        self.horizontalSpacerPipeline = QSpacerItem(
            40, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum
        )
        ...
        self.preprocessLayout.setObjectName("preprocessLayout")
        self.labelPreprocess = QLabel(self.resultPanel)
        self.labelPreprocess.setObjectName("labelPreprocess")

        self.preprocessLayout.addWidget(self.labelPreprocess)

        self.btnOrient = QPushButton(self.resultPanel)
        self.btnOrient.setObjectName("btnOrient")
        ...
        self.btnUnwarp.setObjectName("btnUnwarp")
        ...
        self.btnTextline.setObjectName("btnTextline")
        ...
        self.horizontalSpacerPreprocess = QSpacerItem(
            40, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum
        )
        ...
        self.subPipelineOptions.setObjectName("subPipelineOptions")
        ...
        self.btnSubFormula.setObjectName("btnSubFormula")
        ...
        self.btnSubSeal.setObjectName("btnSubSeal")
        ...
        self.btnVlChart.setObjectName("btnVlChart")
        ...
        self.btnVlSeal.setObjectName("btnVlSeal")
        ...
        self.btnVlFormat.setObjectName("btnVlFormat")
        ...
        self.btnVlOcrImage.setObjectName("btnVlOcrImage")
        ...
        self.horizontalSpacerVl = QSpacerItem(
            40, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum
        )
        ...
        self.groupPreload = QGroupBox(self.tabSettings)
        ...
        self.chkPreloadStructure.setObjectName("chkPreloadStructure")
        ...
        self.chkPreloadPaddleOCRVL.setObjectName("chkPreloadPaddleOCRVL")
        ...
        self.chkParallelPreload.setObjectName("chkParallelPreload")
        ...
        self.labelMaxWorkersHint.setObjectName("labelMaxWorkersHint")
        ...
        self.horizontalSpacerWorkers = QSpacerItem(
            40, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum
        )
        ...
        self.verticalLayout_3.addWidget(self.groupPreload)

        self.groupCache = QGroupBox(self.tabSettings)
        ...
        self.verticalLayout_3.addWidget(self.groupCache)

        self.groupStatus = QGroupBox(self.tabSettings)
        ...
        self.verticalLayout_3.addWidget(self.groupStatus)

        self.groupLLMConfig = QGroupBox(self.tabSettings)
        self.groupLLMConfig.setObjectName("groupLLMConfig")
        self.llmConfigLayout = QVBoxLayout(self.groupLLMConfig)
        self.llmConfigLayout.setSpacing(8)
        self.llmConfigLayout.setObjectName("llmConfigLayout")
        self.labelLLMHint = QLabel(self.groupLLMConfig)
        self.labelLLMHint.setObjectName("labelLLMHint")
        ...
        self.btnSaveLLMConfig.setObjectName("btnSaveLLMConfig")

        self.llmConfigLayout.addWidget(self.btnSaveLLMConfig)

        self.verticalLayout_3.addWidget(self.groupLLMConfig)

        self.groupTemplate = QGroupBox(self.tabSettings)
        ...
        self.labelTemplateHint.setObjectName("labelTemplateHint")
        ...
        self.consoleContainer = QWidget(MainWindowWidget)
        self.consoleContainer.setObjectName("consoleContainer")
        self.consoleContainer.setMinimumSize(QSize(0, 120))
        self.consoleContainer.setMaximumSize(QSize(16777215, 200))

        self.verticalLayout.addWidget(self.consoleContainer)
    ...
    def retranslateUi(self, MainWindowWidget):
        ...
        self.labelPipeline.setText(
            QCoreApplication.translate("MainWindowWidget", "\u7ba1\u9053:", None)
        )
        # if QT_CONFIG(tooltip)
        self.btnPipelineOCR.setToolTip(
            QCoreApplication.translate(
                "MainWindowWidget",
                "\u8bc6\u522b\u56fe\u7247\u4e2d\u7684\u6587\u5b57\u5185\u5bb9",
                None,
        ...
        self.btnPipelineOCR.setText(
            QCoreApplication.translate("MainWindowWidget", "\u901a\u7528", None)
        )
        # if QT_CONFIG(tooltip)
        self.btnPipelineTable.setToolTip(
            QCoreApplication.translate(
                "MainWindowWidget",
                "\u8bc6\u522b\u8868\u683c\u7ed3\u6784\uff0c\u8f93\u51fa HTML \u683c\u5f0f",
                None,
        ...
        # endif // QT_CONFIG(tooltip)
        self.btnPipelineTable.setText(
            QCoreApplication.translate("MainWindowWidget", "\u8868\u683c", None)
        )
        # if QT_CONFIG(tooltip)
        self.btnPipelineFormula.setToolTip(
            QCoreApplication.translate(
                "MainWindowWidget",
                "\u8bc6\u522b\u6570\u5b66\u516c\u5f0f\uff0c\u8f93\u51fa LaTeX \u683c\u5f0f",
                None,
        ...
        # endif // QT_CONFIG(tooltip)
        self.btnPipelineFormula.setText(
            QCoreApplication.translate("MainWindowWidget", "\u516c\u5f0f", None)
        )
        # if QT_CONFIG(tooltip)
        self.btnPipelineStructure.setToolTip(
            QCoreApplication.translate(
                "MainWindowWidget",
                "\u89e3\u6790\u6587\u6863\u7248\u9762\uff0c\u652f\u6301\u8868\u683c\u3001\u516c\u5f0f\u7b49\u5b50\u4ea7\u7ebf",
                None,
        ...
        # endif // QT_CONFIG(tooltip)
        self.btnPipelineStructure.setText(
            QCoreApplication.translate("MainWindowWidget", "\u7248\u9762", None)
        )
        # if QT_CONFIG(tooltip)
        self.btnPipelinePaddleOCRVL.setToolTip(
            QCoreApplication.translate(
                "MainWindowWidget",
                "PaddleOCR-VL\uff1a\u7aef\u5230\u7aef\u6587\u6863\u89e3\u6790\uff0c\u652f\u6301\u8868\u683c\u3001\u516c\u5f0f\u3001\u5370\u7ae0\u3001\u56fe\u8868\u7b49\uff08v1.5 \u652f\u6301\u5f02\u5f62\u6846\u5b9a\u4f4d\uff09",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.btnPipelinePaddleOCRVL.setText(
            QCoreApplication.translate("MainWindowWidget", "PaddleOCR-VL", None)
        )
        self.labelPreprocess.setText(
            QCoreApplication.translate("MainWindowWidget", "\u9884\u5904\u7406:", None)
        )
        # if QT_CONFIG(tooltip)
        self.btnOrient.setToolTip(
            QCoreApplication.translate(
                "MainWindowWidget",
                "\u6587\u6863\u65b9\u5411\u5206\u7c7b\uff1a\u81ea\u52a8\u68c0\u6d4b\u5e76\u77eb\u6b63 0\u00b0/90\u00b0/180\u00b0/270\u00b0 \u65cb\u8f6c",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.btnOrient.setText(
            QCoreApplication.translate("MainWindowWidget", "\u65b9\u5411", None)
        )
        # if QT_CONFIG(tooltip)
        self.btnUnwarp.setToolTip(
            QCoreApplication.translate(
                "MainWindowWidget",
                "\u6587\u6863\u53bb\u5f2f\u66f2\uff1a\u77eb\u6b63\u62cd\u6444/\u626b\u63cf\u8fc7\u7a0b\u4e2d\u7684\u51e0\u4f55\u626d\u66f2",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.btnUnwarp.setText(
            QCoreApplication.translate("MainWindowWidget", "\u53bb\u5f2f", None)
        )
        # if QT_CONFIG(tooltip)
        self.btnTextline.setToolTip(
            QCoreApplication.translate(
                "MainWindowWidget",
                "\u6587\u672c\u884c\u65b9\u5411\uff1a\u68c0\u6d4b\u5e76\u77eb\u6b63\u6587\u672c\u884c\u7684\u65cb\u8f6c\u89d2\u5ea6\uff08\u4ec5\u901a\u7528 OCR\uff09",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.btnTextline.setText(
            QCoreApplication.translate("MainWindowWidget", "\u884c\u5411", None)
        )
        # if QT_CONFIG(tooltip)
        self.btnLayout.setToolTip(
            QCoreApplication.translate(
                "MainWindowWidget",
                "\u7248\u9762\u68c0\u6d4b\uff1a\u68c0\u6d4b\u8868\u683c/\u516c\u5f0f\u533a\u57df\uff08\u4ec5\u8868\u683c\u548c\u516c\u5f0f\u7ba1\u9053\uff09",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.btnLayout.setText(
            QCoreApplication.translate("MainWindowWidget", "\u7248\u9762", None)
        )
        self.labelSubPipelines.setText(
            QCoreApplication.translate("MainWindowWidget", "\u5b50\u4ea7\u7ebf:", None)
        )
        # if QT_CONFIG(tooltip)
        self.btnSubTable.setToolTip(
            QCoreApplication.translate(
                "MainWindowWidget",
                "\u542f\u7528\u8868\u683c\u8bc6\u522b\u5b50\u4ea7\u7ebf",
                None,
        ...
        # endif // QT_CONFIG(tooltip)
        self.btnSubTable.setText(
            QCoreApplication.translate("MainWindowWidget", "\u8868\u683c", None)
        )
        # if QT_CONFIG(tooltip)
        self.btnSubFormula.setToolTip(
            QCoreApplication.translate(
                "MainWindowWidget",
                "\u542f\u7528\u516c\u5f0f\u8bc6\u522b\u5b50\u4ea7\u7ebf",
                None,
        ...
        # endif // QT_CONFIG(tooltip)
        self.btnSubFormula.setText(
            QCoreApplication.translate("MainWindowWidget", "\u516c\u5f0f", None)
        )
        # if QT_CONFIG(tooltip)
        self.btnSubSeal.setToolTip(
            QCoreApplication.translate(
                "MainWindowWidget",
                "\u542f\u7528\u5370\u7ae0\u8bc6\u522b\u5b50\u4ea7\u7ebf",
                None,
        ...
        # endif // QT_CONFIG(tooltip)
        self.btnSubSeal.setText(
            QCoreApplication.translate("MainWindowWidget", "\u5370\u7ae0", None)
        )
        # if QT_CONFIG(tooltip)
        self.btnSubChart.setToolTip(
            QCoreApplication.translate(
                "MainWindowWidget",
                "\u542f\u7528\u56fe\u8868\u8bc6\u522b\u5b50\u4ea7\u7ebf",
                None,
        ...
        # endif // QT_CONFIG(tooltip)
        self.btnSubChart.setText(
            QCoreApplication.translate("MainWindowWidget", "\u56fe\u8868", None)
        )
        self.labelVlOptions.setText(
            QCoreApplication.translate("MainWindowWidget", "V-L \u9009\u9879:", None)
        )
        # if QT_CONFIG(tooltip)
        self.btnVlLayout.setToolTip(
            QCoreApplication.translate(
                "MainWindowWidget",
                "\u542f\u7528\u7248\u9762\u533a\u57df\u68c0\u6d4b\u6392\u5e8f\uff08\u9ed8\u8ba4\u5f00\u542f\uff09",
                None,
        ...
        # endif // QT_CONFIG(tooltip)
        self.btnVlLayout.setText(
            QCoreApplication.translate(
                "MainWindowWidget", "\u7248\u9762\u68c0\u6d4b", None
            )
        )
        # if QT_CONFIG(tooltip)
        self.btnVlChart.setToolTip(
            QCoreApplication.translate(
                "MainWindowWidget",
                "\u542f\u7528\u56fe\u8868\u89e3\u6790\u529f\u80fd",
                None,
        ...
        # endif // QT_CONFIG(tooltip)
        self.btnVlChart.setText(
            QCoreApplication.translate("MainWindowWidget", "\u56fe\u8868", None)
        )
        # if QT_CONFIG(tooltip)
        self.btnVlSeal.setToolTip(
            QCoreApplication.translate(
                "MainWindowWidget",
                "\u542f\u7528\u5370\u7ae0\u8bc6\u522b\u529f\u80fd\uff08v1.5 \u65b0\u589e\uff09",
                None,
        ...
        # endif // QT_CONFIG(tooltip)
        self.btnVlSeal.setText(
            QCoreApplication.translate("MainWindowWidget", "\u5370\u7ae0", None)
        )
        # if QT_CONFIG(tooltip)
        self.btnVlFormat.setToolTip(
            QCoreApplication.translate(
                "MainWindowWidget",
                "\u5c06\u7ed3\u679c\u683c\u5f0f\u5316\u4e3a Markdown \u683c\u5f0f",
                None,
        ...
        # endif // QT_CONFIG(tooltip)
        self.btnVlFormat.setText(
            QCoreApplication.translate("MainWindowWidget", "\u683c\u5f0f\u5316", None)
        )
        # if QT_CONFIG(tooltip)
        self.btnVlOcrImage.setToolTip(
            QCoreApplication.translate(
                "MainWindowWidget",
                "\u5bf9\u56fe\u7247\u5757\u4e2d\u7684\u6587\u5b57\u8fdb\u884c OCR \u8bc6\u522b",
                None,
        ...
        # endif // QT_CONFIG(tooltip)
        self.btnVlOcrImage.setText(
            QCoreApplication.translate("MainWindowWidget", "\u56fe\u5185 OCR", None)
        )
        self.textResult.setPlaceholderText(
            QCoreApplication.translate(
                "MainWindowWidget",
                "\u8bc6\u522b\u7ed3\u679c\u5c06\u663e\u793a\u5728\u8fd9\u91cc...",
                None,
        ...
        self.tabWidget.setTabText(
            ...
            QCoreApplication.translate("MainWindowWidget", "OCR \u8bc6\u522b", None),
        )
        ...
        # if QT_CONFIG(tooltip)
        self.chkPreloadStructure.setToolTip(
            QCoreApplication.translate(
                "MainWindowWidget",
                "\u7248\u9762\u89e3\u6790\u7ba1\u9053\uff08\u5305\u542b 15+ \u6a21\u578b\uff0c\u7ea6 2-3GB \u663e\u5b58\uff09",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.chkPreloadStructure.setText(
            QCoreApplication.translate("MainWindowWidget", "\u7248\u9762", None)
        )
        # if QT_CONFIG(tooltip)
        self.chkPreloadPaddleOCRVL.setToolTip(
            QCoreApplication.translate(
                "MainWindowWidget",
                "PaddleOCR-VL \u7aef\u5230\u7aef\u6587\u6863\u89e3\u6790\uff08v1.5 \u652f\u6301\u5f02\u5f62\u6846\u5b9a\u4f4d\uff09",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.chkPreloadPaddleOCRVL.setText(
            QCoreApplication.translate("MainWindowWidget", "PaddleOCR-VL", None)
        )
        # if QT_CONFIG(tooltip)
        self.chkParallelPreload.setToolTip(
            QCoreApplication.translate(
                "MainWindowWidget",
                "\u5e76\u884c\u52a0\u8f7d\u591a\u4e2a\u7ba1\u9053\u53ef\u52a0\u5feb\u901f\u5ea6\uff0c\u4f46\u4f1a\u589e\u52a0\u5cf0\u503c\u663e\u5b58\u5360\u7528",
                None,
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.chkParallelPreload.setText(
            QCoreApplication.translate(
                "MainWindowWidget",
                "\u5e76\u884c\u52a0\u8f7d\uff08\u52a0\u5feb\u901f\u5ea6\uff0c\u589e\u52a0\u663e\u5b58\uff09",
                None,
        ...
        self.labelMaxWorkers.setText(
            QCoreApplication.translate(
                "MainWindowWidget", "\u5e76\u884c\u6570\u91cf:", None
            )
        )
        # if QT_CONFIG(tooltip)
        ...
        # endif // QT_CONFIG(tooltip)
        self.labelMaxWorkersHint.setText(
            QCoreApplication.translate(
                "MainWindowWidget", "(\u5efa\u8bae\u4e0d\u8d85\u8fc7 2)", None
            )
        )
        # if QT_CONFIG(tooltip)
        ...
        self.btnClearCache.setText(
            QCoreApplication.translate(
                "MainWindowWidget", "\u6e05\u9664\u7f13\u5b58", None
            )
        )
        self.labelCacheStatus.setText(
            QCoreApplication.translate(
                "MainWindowWidget", "\u7f13\u5b58\u72b6\u6001: \u672a\u77e5", None
            )
        )
        self.groupStatus.setTitle(
            QCoreApplication.translate(
                "MainWindowWidget", "\u9884\u52a0\u8f7d\u72b6\u6001", None
            )
        )
        ...
        self.groupLLMConfig.setTitle(
            QCoreApplication.translate(
                "MainWindowWidget", "LLM \u670d\u52a1\u914d\u7f6e", None
            )
        )
        self.labelLLMHint.setText(
            QCoreApplication.translate(
                "MainWindowWidget",
                "\u914d\u7f6e LLM \u670d\u52a1\u4ee5\u542f\u7528\u4fe1\u606f\u62bd\u53d6\u529f\u80fd",
                None,
        ...
        self.labelMLLMUrl.setText(
            QCoreApplication.translate(
                "MainWindowWidget", "MLLM \u670d\u52a1\u5730\u5740:", None
            )
        )
        self.editMLLMUrl.setPlaceholderText(
            QCoreApplication.translate(
                "MainWindowWidget", "http://127.0.0.1:8080/v1/chat/completions", None
            )
        )
        self.labelMLLMModel.setText(
            QCoreApplication.translate(
                "MainWindowWidget", "MLLM \u6a21\u578b\u540d\u79f0:", None
            )
        )
        ...
        self.editLLMUrl.setPlaceholderText(
            QCoreApplication.translate(
                "MainWindowWidget", "http://127.0.0.1:8080/v1/chat/completions", None
            )
        )
        self.labelLLMModel.setText(
            QCoreApplication.translate(
                "MainWindowWidget", "LLM \u6a21\u578b\u540d\u79f0:", None
            )
        )
        ...
        self.btnSaveLLMConfig.setText(
            QCoreApplication.translate(
                "MainWindowWidget", "\u4fdd\u5b58\u914d\u7f6e", None
            )
        )
        self.groupTemplate.setTitle(
            QCoreApplication.translate(
                "MainWindowWidget", "\u62bd\u53d6\u6a21\u677f\u7ba1\u7406", None
            )
        )
        self.labelTemplateHint.setText(
            QCoreApplication.translate(
                "MainWindowWidget",
                "\u7ba1\u7406\u5e38\u7528\u7684\u62bd\u53d6\u5b57\u6bb5\u6a21\u677f",
                None,
        ...
        self.btnEditTemplate.setText(
            QCoreApplication.translate(
                "MainWindowWidget", "\u7f16\u8f91\u6a21\u677f", None
            )
        )
