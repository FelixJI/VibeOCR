...
class Ui_MainWindowWidget(object):
    def setupUi(self, MainWindowWidget):
        ...
        self.editApiKey.setObjectName(u"editApiKey")
    ...
    def retranslateUi(self, MainWindowWidget):
        ...
        self.labelApiKey.setText(QCoreApplication.translate("MainWindowWidget", u"API Key (\u53ef\u9009):", None))
        self.editApiKey.setPlaceholderText(QCoreApplication.translate("MainWindowWidget", u"\u7559\u7a7a\u8868\u793a\u4e0d\u9700\u8981 API Key", None))
