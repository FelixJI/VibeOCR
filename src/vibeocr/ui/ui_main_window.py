...
class Ui_MainWindowWidget:
    def setupUi(self, MainWindowWidget):
        ...
        self.pageModelManagement.setObjectName("pageModelManagement")
        self.pageModelLayout = QVBoxLayout(self.pageModelManagement)
        self.pageModelLayout.setSpacing(12)
        self.pageModelLayout.setObjectName("pageModelLayout")
        ...
        self.chkPreload_FORMULA_RECOGNITION.setObjectName("chkPreload_FORMULA_RECOGNITION")
        ...
        self.pageAppSettings.setObjectName("pageAppSettings")
        self.pageAppLayout = QVBoxLayout(self.pageAppSettings)
        self.pageAppLayout.setSpacing(12)
        self.pageAppLayout.setObjectName("pageAppLayout")
        ...
        self.backendOptionsContainerLayout.setObjectName("backendOptionsContainerLayout")
    ...
    def retranslateUi(self, MainWindowWidget):
        self.labelResultTitle.setText(QCoreApplication.translate("MainWindowWidget", "\u8bc6\u522b\u7ed3\u679c", None))
#if QT_CONFIG(tooltip)
        self.btnCopyRich.setToolTip(QCoreApplication.translate("MainWindowWidget", "\u590d\u5236\u4e3a\u5bcc\u6587\u672c\u683c\u5f0f\uff0c\u53ef\u7c98\u8d34\u5230 Word/Excel \u4fdd\u7559\u8868\u683c\u683c\u5f0f", None))
#endif // QT_CONFIG(tooltip)
        self.btnCopyRich.setText(QCoreApplication.translate("MainWindowWidget", "\u5bcc\u6587\u672c", None))
#if QT_CONFIG(tooltip)
        self.btnCopyMarkdown.setToolTip(QCoreApplication.translate("MainWindowWidget", "\u590d\u5236\u4e3a Markdown \u683c\u5f0f\uff0c\u4fdd\u7559\u8868\u683c\u548c\u516c\u5f0f\u7ed3\u6784", None))
#endif // QT_CONFIG(tooltip)
        self.btnCopyMarkdown.setText(QCoreApplication.translate("MainWindowWidget", "Markdown", None))
#if QT_CONFIG(tooltip)
        self.btnCopyPlain.setToolTip(QCoreApplication.translate("MainWindowWidget", "\u590d\u5236\u4e3a\u7eaf\u6587\u672c\u683c\u5f0f", None))
#endif // QT_CONFIG(tooltip)
        self.btnCopyPlain.setText(QCoreApplication.translate("MainWindowWidget", "\u7eaf\u6587\u672c", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabOCR), QCoreApplication.translate("MainWindowWidget", "\u5355\u6b21\u8bc6\u522b", None))
        ...
        ___qlistwidgetitem.setText(QCoreApplication.translate("MainWindowWidget", "\u6a21\u578b\u7ba1\u7406", None))
        ___qlistwidgetitem1 = self.settingsNavList.item(1)
        ___qlistwidgetitem1.setText(QCoreApplication.translate("MainWindowWidget", "\u5e94\u7528\u8bbe\u7f6e", None))
        self.settingsNavList.setSortingEnabled(__sortingEnabled)

        self.groupPreload.setTitle(QCoreApplication.translate("MainWindowWidget", "\u6a21\u578b\u9884\u52a0\u8f7d", None))
#if QT_CONFIG(tooltip)
        self.chkEnablePreload.setToolTip(QCoreApplication.translate("MainWindowWidget", "\u542f\u52a8\u5e94\u7528\u65f6\u81ea\u52a8\u9884\u52a0\u8f7d\u9009\u4e2d\u7684\u7ba1\u9053\uff0c\u9996\u6b21\u8bc6\u522b\u65f6\u65e0\u9700\u7b49\u5f85", None))
#endif // QT_CONFIG(tooltip)
        self.chkEnablePreload.setText(QCoreApplication.translate("MainWindowWidget", "\u542f\u52a8\u65f6\u81ea\u52a8\u9884\u52a0\u8f7d\u6a21\u578b", None))
        self.labelPreloadPipelines.setText(QCoreApplication.translate("MainWindowWidget", "\u9884\u52a0\u8f7d\u7ba1\u9053:", None))
#if QT_CONFIG(tooltip)
        self.chkPreload_OCR.setToolTip(QCoreApplication.translate("MainWindowWidget", "\u901a\u7528 OCR \u7ba1\u9053\uff08\u7ea6 600MB \u663e\u5b58\uff09", None))
#endif // QT_CONFIG(tooltip)
        self.chkPreload_OCR.setText(QCoreApplication.translate("MainWindowWidget", "\u901a\u7528 OCR", None))
#if QT_CONFIG(tooltip)
        self.chkPreload_PP_STRUCTURE_V3.setToolTip(QCoreApplication.translate("MainWindowWidget", "PP-StructureV3 \u6587\u6863\u7ed3\u6784\u5206\u6790\u7ba1\u9053", None))
#endif // QT_CONFIG(tooltip)
        self.chkPreload_PP_STRUCTURE_V3.setText(QCoreApplication.translate("MainWindowWidget", "PP-StructureV3", None))
#if QT_CONFIG(tooltip)
        self.chkPreload_PADDLEOCR_VL.setToolTip(QCoreApplication.translate("MainWindowWidget", "PaddleOCR-VL \u6587\u6863\u89e3\u6790\u7ba1\u9053", None))
#endif // QT_CONFIG(tooltip)
        self.chkPreload_PADDLEOCR_VL.setText(QCoreApplication.translate("MainWindowWidget", "\u6587\u6863P", None))
#if QT_CONFIG(tooltip)
        self.chkPreload_TABLE_RECOGNITION.setToolTip(QCoreApplication.translate("MainWindowWidget", "\u8868\u683c\u8bc6\u522b\u7ba1\u9053", None))
#endif // QT_CONFIG(tooltip)
        self.chkPreload_TABLE_RECOGNITION.setText(QCoreApplication.translate("MainWindowWidget", "\u8868\u683c", None))
#if QT_CONFIG(tooltip)
        self.chkPreload_FORMULA_RECOGNITION.setToolTip(QCoreApplication.translate("MainWindowWidget", "\u516c\u5f0f\u8bc6\u522b\u7ba1\u9053", None))
#endif // QT_CONFIG(tooltip)
        self.chkPreload_FORMULA_RECOGNITION.setText(QCoreApplication.translate("MainWindowWidget", "\u516c\u5f0f", None))
#if QT_CONFIG(tooltip)
        self.btnPreloadNow.setToolTip(QCoreApplication.translate("MainWindowWidget", "\u7acb\u5373\u9884\u52a0\u8f7d\u9009\u4e2d\u7684\u7ba1\u9053", None))
#endif // QT_CONFIG(tooltip)
        self.btnPreloadNow.setText(QCoreApplication.translate("MainWindowWidget", "\u7acb\u5373\u9884\u52a0\u8f7d", None))
        self.labelPreloadStatus.setText(QCoreApplication.translate("MainWindowWidget", "\u5c1a\u672a\u9884\u52a0\u8f7d", None))
        self.groupCache.setTitle(QCoreApplication.translate("MainWindowWidget", "\u7f13\u5b58\u7ba1\u7406", None))
#if QT_CONFIG(tooltip)
        self.btnRefreshCache.setToolTip(QCoreApplication.translate("MainWindowWidget", "\u91cd\u65b0\u626b\u63cf\u6a21\u578b\u7f13\u5b58\u72b6\u6001", None))
#endif // QT_CONFIG(tooltip)
        self.btnRefreshCache.setText(QCoreApplication.translate("MainWindowWidget", "\u5237\u65b0\u7f13\u5b58\u72b6\u6001", None))
#if QT_CONFIG(tooltip)
        self.btnClearCache.setToolTip(QCoreApplication.translate("MainWindowWidget", "\u6e05\u9664\u4f9d\u8d56\u68c0\u6d4b\u7f13\u5b58\uff08\u4e0d\u5f71\u54cd\u5df2\u4e0b\u8f7d\u7684\u6a21\u578b\uff09", None))
#endif // QT_CONFIG(tooltip)
        self.btnClearCache.setText(QCoreApplication.translate("MainWindowWidget", "\u6e05\u9664\u7f13\u5b58", None))
        self.labelCacheStatus.setText(QCoreApplication.translate("MainWindowWidget", "\u7f13\u5b58\u72b6\u6001: \u672a\u77e5", None))
        self.groupAppSettings.setTitle(QCoreApplication.translate("MainWindowWidget", "\u5e94\u7528\u8bbe\u7f6e", None))
        self.labelToolbarDesc.setText(QCoreApplication.translate("MainWindowWidget", "\u8fb9\u7f18\u5de5\u5177\u680f\uff1a\u60ac\u6d6e\u5728\u5c4f\u5e55\u8fb9\u7f18\u7684\u5feb\u6377\u5de5\u5177\u6761\uff0c\u63d0\u4f9b\u4e00\u952e\u622a\u56fe\u548c\u547c\u51fa\u4e3b\u7a97\u53e3\u3002\u53ef\u62d6\u52a8\u5230\u5c4f\u5e55\u4efb\u610f\u8fb9\u7f18\uff0c\u505c\u9760\u540e\u81ea\u52a8\u9690\u85cf\uff0c\u9f20\u6807\u9760\u8fd1\u65f6\u5f39\u51fa\u3002", None))
#if QT_CONFIG(tooltip)
        self.chkShowToolbar.setToolTip(QCoreApplication.translate("MainWindowWidget", "\u663e\u793a\u684c\u9762\u8fb9\u7f18\u6d6e\u52a8\u5de5\u5177\u680f\uff0c\u63d0\u4f9b\u5feb\u901f\u622a\u56fe\u548c\u4e3b\u7a97\u53e3\u5165\u53e3", None))
#endif // QT_CONFIG(tooltip)
        self.chkShowToolbar.setText(QCoreApplication.translate("MainWindowWidget", "\u663e\u793a\u8fb9\u7f18\u5de5\u5177\u680f", None))
#if QT_CONFIG(tooltip)
        self.chkAutoHideToolbar.setToolTip(QCoreApplication.translate("MainWindowWidget", "\u5de5\u5177\u680f\u505c\u9760\u5728\u5c4f\u5e55\u8fb9\u7f18\u65f6\u81ea\u52a8\u9690\u85cf\uff0c\u9f20\u6807\u9760\u8fd1\u8fb9\u7f18\u65f6\u81ea\u52a8\u5f39\u51fa", None))
#endif // QT_CONFIG(tooltip)
        self.chkAutoHideToolbar.setText(QCoreApplication.translate("MainWindowWidget", "\u81ea\u52a8\u9690\u85cf", None))
        self.labelHideDelay.setText(QCoreApplication.translate("MainWindowWidget", "\u9690\u85cf\u5ef6\u8fdf:", None))
        self.spinHideDelay.setSuffix(QCoreApplication.translate("MainWindowWidget", " \u6beb\u79d2", None))
#if QT_CONFIG(tooltip)
        self.chkMinimizeToTray.setToolTip(QCoreApplication.translate("MainWindowWidget", "\u5173\u95ed\u4e3b\u7a97\u53e3\u65f6\u6700\u5c0f\u5316\u5230\u7cfb\u7edf\u6258\u76d8\u800c\u4e0d\u662f\u9000\u51fa\u7a0b\u5e8f", None))
#endif // QT_CONFIG(tooltip)
        self.chkMinimizeToTray.setText(QCoreApplication.translate("MainWindowWidget", "\u6700\u5c0f\u5316\u5230\u7cfb\u7edf\u6258\u76d8", None))
#if QT_CONFIG(tooltip)
        self.chkAutoStart.setToolTip(QCoreApplication.translate("MainWindowWidget", "\u7cfb\u7edf\u542f\u52a8\u65f6\u81ea\u52a8\u8fd0\u884c VibeOCR", None))
#endif // QT_CONFIG(tooltip)
        self.chkAutoStart.setText(QCoreApplication.translate("MainWindowWidget", "\u5f00\u673a\u81ea\u542f\u52a8", None))
        self.groupEnvMaintenance.setTitle(QCoreApplication.translate("MainWindowWidget", "\u63a8\u7406\u540e\u7aef\u4e0e\u4f9d\u8d56", None))
        self.labelEnvStatus.setText(QCoreApplication.translate("MainWindowWidget", "Python \u8fd0\u884c\u65f6\uff1a\u68c0\u6d4b\u4e2d...", None))
        ___qtreewidgetitem = self.treeDepsStatus.headerItem()
        ___qtreewidgetitem.setText(2, QCoreApplication.translate("MainWindowWidget", "\u7248\u672c", None))
        ___qtreewidgetitem.setText(1, QCoreApplication.translate("MainWindowWidget", "\u72b6\u6001", None))
        ___qtreewidgetitem.setText(0, QCoreApplication.translate("MainWindowWidget", "\u4f9d\u8d56", None))
#if QT_CONFIG(tooltip)
        self.treeDepsStatus.setToolTip(QCoreApplication.translate("MainWindowWidget", "\u5404 OCR \u4f9d\u8d56\u7684\u5b89\u88c5\u72b6\u6001\uff08\u4ec5\u4fbf\u643a\u6a21\u5f0f\u53ef\u89c1\uff09\u3002\u70b9\u51fb\u9876\u5c42\u5305\u5de6\u4fa7\u7bad\u5934\u5c55\u5f00\u5176\u95f4\u63a5\u4f9d\u8d56\uff1b\u6309\u4f4f Ctrl/Shift \u591a\u9009\u540e\u70b9\"\u91cd\u88c5\u9009\u4e2d\u9879\"\u6279\u91cf\u91cd\u88c5\u3002", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.btnReinstallSelected.setToolTip(QCoreApplication.translate("MainWindowWidget", "\u91cd\u88c5\u4e0a\u65b9\u4f9d\u8d56\u6811\u4e2d\u9009\u4e2d\u7684\u9876\u5c42\u5305\uff08\u6309 Ctrl/Shift \u591a\u9009\uff09\u3002\u95f4\u63a5\u4f9d\u8d56\u901a\u8fc7\u91cd\u88c5\u5176\u627f\u8f7d\u9876\u5c42\u5305\u4fee\u590d\uff0c\u65e0\u9700\u9010\u4e2a\u9009 leaf\u3002", None))
#endif // QT_CONFIG(tooltip)
        self.btnReinstallSelected.setText(QCoreApplication.translate("MainWindowWidget", "\u91cd\u88c5\u9009\u4e2d\u9879", None))
#if QT_CONFIG(tooltip)
        self.btnReinstallPython.setToolTip(QCoreApplication.translate("MainWindowWidget", "\u5220\u9664 python/ \u76ee\u5f55\u540e\u91cd\u65b0\u4e0b\u8f7d\u5b89\u88c5 Python \u8fd0\u884c\u65f6\u53ca OCR \u4f9d\u8d56\u3002\u4ec5\u5220\u9664 python/\uff0c\u4e0d\u5f71\u54cd\u914d\u7f6e\u3001\u6a21\u578b\u7f13\u5b58\u548c\u65e5\u5fd7\u3002", None))
#endif // QT_CONFIG(tooltip)
        self.btnReinstallPython.setText(QCoreApplication.translate("MainWindowWidget", "\u91cd\u88c5 Python \u8fd0\u884c\u65f6", None))
#if QT_CONFIG(tooltip)
        self.btnReinstallDeps.setToolTip(QCoreApplication.translate("MainWindowWidget", "\u4f7f\u7528 pip \u91cd\u65b0\u5b89\u88c5 paddle/torch/mineru \u7b49 OCR \u4f9d\u8d56\uff0c\u4e0d\u5220\u9664\u4efb\u4f55\u76ee\u5f55\u3002", None))
#endif // QT_CONFIG(tooltip)
        self.btnReinstallDeps.setText(QCoreApplication.translate("MainWindowWidget", "\u91cd\u88c5 OCR \u4f9d\u8d56", None))
#if QT_CONFIG(tooltip)
        self.btnInstallMissing.setToolTip(QCoreApplication.translate("MainWindowWidget", "\u53ea\u5b89\u88c5\u7f3a\u5931\u7684 OCR \u4f9d\u8d56\uff08\u5df2\u5b89\u88c5\u7684\u81ea\u52a8\u8df3\u8fc7\uff0c\u4e0d\u91cd\u590d\u4e0b\u8f7d\uff09\u3002\u9002\u5408\u4e0a\u6b21\u5b89\u88c5\u4e2d\u9014\u5931\u8d25\u540e\u8865\u88c5\u3002", None))
#endif // QT_CONFIG(tooltip)
        self.btnInstallMissing.setText(QCoreApplication.translate("MainWindowWidget", "\u8865\u5145\u5b89\u88c5\u7f3a\u5931\u4f9d\u8d56", None))
#if QT_CONFIG(tooltip)
        self.btnUpdateDeps.setToolTip(QCoreApplication.translate("MainWindowWidget", "\u68c0\u6d4b\u5404 OCR \u4f9d\u8d56\u662f\u5426\u6709\u65b0\u7248\u672c\u53ef\u7528\uff08\u4f9d\u636e\u5f53\u524d\u4e3b\u7a0b\u5e8f\u8981\u6c42\u7684\u7248\u672c\u89c4\u683c\uff09\uff0c\u6709\u5219\u5347\u7ea7\u3002\u8986\u76d6\u5b89\u88c5\u540e\u82e5\u4f9d\u8d56\u7248\u672c\u53d8\u5316\u4e5f\u53ef\u7528\u6b64\u5165\u53e3\u624b\u52a8\u66f4\u65b0\u3002", None))
#endif // QT_CONFIG(tooltip)
        self.btnUpdateDeps.setText(QCoreApplication.translate("MainWindowWidget", "\u66f4\u65b0\u4f9d\u8d56", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabSettings), QCoreApplication.translate("MainWindowWidget", "\u8bbe\u7f6e", None))
    # retranslateUi
