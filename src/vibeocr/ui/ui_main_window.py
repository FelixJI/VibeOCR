...
class Ui_MainWindowWidget:
    def setupUi(self, MainWindowWidget):
        ...
        self.scrollAreaSettingsContent.setObjectName("scrollAreaSettingsContent")
        ...
        self.llmButtonLayout.setObjectName("llmButtonLayout")
        self.horizontalSpacerLLM = QSpacerItem(
            40, 20, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum
        )
