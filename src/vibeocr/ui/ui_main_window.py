...
class Ui_MainWindowWidget(object):
    def setupUi(self, MainWindowWidget):
        ...
        self.spacerModelPage = QSpacerItem(
        ...
        self.labelModelDownloadHint.setObjectName("labelModelDownloadHint")
        ...
        self.spacerToolsPage = QSpacerItem(
            20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding
        )
    ...
    def retranslateUi(self, MainWindowWidget):
        ...
        ___qlistwidgetitem2.setText(
            QCoreApplication.translate("MainWindowWidget", "\u5de5\u5177", None)
        )
        ...
        self.groupModelDownload.setTitle(
            QCoreApplication.translate(
                "MainWindowWidget", "\u6a21\u578b\u4e0b\u8f7d", None
            )
        )
        # if QT_CONFIG(tooltip)
        self.btnDownloadModels.setToolTip(
            QCoreApplication.translate(
                "MainWindowWidget",
                "\u4e0b\u8f7d\u6216\u66f4\u65b0 OCR \u6a21\u578b\u6587\u4ef6",
                None,
        ...
        # endif // QT_CONFIG(tooltip)
        self.btnDownloadModels.setText(
            QCoreApplication.translate(
                "MainWindowWidget", "\u4e0b\u8f7d\u6a21\u578b", None
            )
        )
        self.labelModelDownloadHint.setText(
            QCoreApplication.translate(
                "MainWindowWidget",
                "\u4e0b\u8f7d\u6216\u66f4\u65b0 OCR \u6a21\u578b\u6587\u4ef6\uff08PaddleOCR\u3001\u8868\u683c\u8bc6\u522b\u3001\u516c\u5f0f\u8bc6\u522b\u7b49\uff09",
                None,
            )
        )
        self.tabWidget.setTabText(
