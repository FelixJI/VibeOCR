...
from vibeocr.backend.runtime_state import CACHE_VERSION as RUNTIME_CACHE_VERSION
from vibeocr.classic.machine_cache import CACHE_VERSION
...
class TestGenerateMachineId:
    ...
    def test_generate_machine_id_returns_string(self):
        ...
        from vibeocr.classic.machine_cache import generate_machine_id
    ...
    @patch("vibeocr.classic.machine_cache.subprocess.run")
...
class TestCachePath:
    ...
    def test_get_cache_dir(self, tmp_path):
        ...
        from vibeocr.classic.machine_cache import get_cache_dir
    ...
    def test_get_cache_path(self, tmp_path):
        ...
        from vibeocr.classic.machine_cache import get_cache_path
...
class TestCacheReadWrite:
    ...
    def test_save_and_load_cache(self, tmp_path):
        ...
        from vibeocr.classic.machine_cache import load_cache, save_cache
    ...
    def test_load_cache_returns_none_if_not_exists(self, tmp_path):
        ...
        from vibeocr.classic.machine_cache import load_cache
    ...
    def test_save_cache_creates_directory(self, tmp_path):
        ...
        from vibeocr.classic.machine_cache import save_cache
    ...
    def test_save_cache_is_atomic_on_replace_failure(self, tmp_path):
        ...
        with patch("vibeocr.classic.machine_cache.os.replace", side_effect=OSError("boom")):
...
class TestCacheValidation:
    ...
    def test_is_cache_valid_returns_false_if_machine_id_mismatch(self, tmp_path):
        ...
        from vibeocr.classic.machine_cache import is_cache_valid, save_cache
...
class TestCacheOperations:
    ...
    def test_clear_cache_removes_file(self, tmp_path):
        ...
        from vibeocr.classic.machine_cache import clear_cache, load_cache, save_cache
    ...
    def test_clear_cache_returns_true_if_no_file(self, tmp_path):
        ...
        from vibeocr.classic.machine_cache import clear_cache
...
class TestEnvManagerIntegration:
    ...
    def test_check_dependencies_uses_cache(self, tmp_path, monkeypatch):
        ...
        from vibeocr.backend.runtime_state import generate_machine_id, save_cache
...
class TestCacheTTLRevalidation:
    ...
    def test_ttl_expired_revalidates_true_entries(self, tmp_path):
        ...
        """
        from vibeocr.backend.env_manager import check_embedded_environment_dependencies
        from vibeocr.backend.runtime_state import load_cache
    ...
    def test_get_cache_age_seconds_returns_none_without_cache(self, tmp_path):
        ...
        from vibeocr.classic.machine_cache import get_cache_age_seconds
...
class TestWarmupMachineId:
    ...
    def test_warmup_machine_id_caches_result(self, monkeypatch):
        ...
        import vibeocr.classic.machine_cache as mc
...
class TestIsEmbeddedEnvironmentReady:
    ...
    def test_python_not_installed_returns_missing(self, tmp_path):
        ...
        from vibeocr.backend.env_manager import is_embedded_environment_ready
    ...
    def test_all_required_deps_present_returns_ready(self, tmp_path):
        ...
        with (
            ...
            patch(
                "vibeocr.backend.env_manager.check_embedded_environment_dependencies",
...
class TestGetCacheInfo:
    ...
    def test_minimal_cache_shows_empty_placeholders(self, tmp_path):
        ...
        from vibeocr.classic.machine_cache import get_cache_info, save_cache
...
class TestMachineCacheBranches:
    ...
    def test_get_cache_age_seconds_invalid_timestamp(self, tmp_path):
        ...
        from vibeocr.classic.machine_cache import get_cache_age_seconds, save_cache
    ...
    def test_clear_cache_failure_returns_false(self, tmp_path):
        ...
        from vibeocr.classic.machine_cache import clear_cache, save_cache
    ...
    def test_reset_cache_to_empty_save_failure(self, tmp_path):
        ...
        with patch("vibeocr.classic.machine_cache.save_cache", return_value=False):
    ...
    def test_reset_cache_to_empty_exception(self, tmp_path):
        ...
        with patch(
            "vibeocr.classic.machine_cache.generate_machine_id",
    ...
    def test_create_cache_entry_save_failure(self, tmp_path):
        ...
        from vibeocr.classic.machine_cache import create_cache_entry
    ...
    def test_get_cpu_id_wmic_success(self):
        ...
        from vibeocr.classic.machine_cache import _get_cpu_id

        fake_result = MagicMock()
        fake_result.returncode = 0
        fake_result.stdout = "ProcessorId\nABC123\n"
        with (
            patch("vibeocr.classic.machine_cache.os.name", "nt"),
            patch(
                "vibeocr.classic.machine_cache.subprocess.run", return_value=fake_result
            ),
        ):
    ...
    def test_get_cpu_id_non_windows(self):
        ...
        with patch("vibeocr.classic.machine_cache.os.name", "posix"):
            assert _get_cpu_id() == ""

    def test_get_baseboard_serial_wmic_success(self):
        """wmic 成功返回 serialnumber 时 _get_baseboard_serial 应解析第二行。"""
        from vibeocr.classic.machine_cache import _get_baseboard_serial
    ...
    def test_update_cache_field_invalid_cache_returns_false(self, tmp_path):
        ...
        from vibeocr.classic.machine_cache import update_cache_field
