...
:class:`~vibeocr.supervisor.inference.paddle_executor.AdapterExecutor`; only
the adapter type differs. The supervisor routes ``MINERU_PARSE`` jobs to this
executor via :class:`~vibeocr.supervisor.inference.composite_executor.CompositeExecutor`.
"""
