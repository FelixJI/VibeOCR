...
from .errors import ErrorCode, ErrorPayload
from .generated.operations import OPERATION_IDS_BY_NAME, operation_path
from .generated.server import RESPONSE_JSON_SCHEMAS
from .parser import (
    parse_error_payload,
    parse_job_ref,
    parse_job_update,
...
if TYPE_CHECKING:
    from .generated.wire_types import (
        CommandResult,
        ExportRequest,
        ExportResponse,
        Health,
...
class SupervisorClient:
    ...
    async def _log_http_response(self, _response: Any) -> None:
        """Optional product logging hook retained for compatibility."""
